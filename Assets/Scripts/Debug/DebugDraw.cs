...
public static class DebugDraw
{
    ...
    {
        Cylinder(center, radius, height, color, duration, nbRay);
        ...
        Vector3 topSphereCenter = center + new Vector3(0, height / 2, 0);
        Vector3 bottomSphereCenter = center - new Vector3(0, height / 2, 0);
        ...
        for(int i = 0; i < sphereNbPart / 2; i++)
        {
            ...
            for (int j = 0; j < nbRay; j++)
            {
                ...
                Vector3 realPos1 = pos1 + topSphereCenter;
                Vector3 realPos2 = pos2 + topSphereCenter;

                Line(realPos1, realPos2, color, duration);

                realPos1 = pos1 + bottomSphereCenter;
                realPos1.y -= pos1.y * 2;
                realPos2 = pos2 + bottomSphereCenter;
                realPos2.y -= pos2.y * 2;
