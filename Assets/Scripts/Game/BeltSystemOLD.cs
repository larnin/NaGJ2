...
public class BeltSystemOLD : MonoBehaviour
{
    [SerializeField] float m_resourceOffset;

    class Container
    {
        public BuildingContainerOLD container;
    ...
    List<BuildingOnePortDataOLD> m_ports = new List<BuildingOnePortDataOLD>();
    ...
    bool IsForward(BuildingOneBeltDataOLD first, BuildingOneBeltDataOLD second)
    {
