...
class OLDEnemy : MonoBehaviour
{
    ...
    private void OnDestroy()
    {
        ...
        OLDEntityList.Remove(gameObject);
    }
    ...
    private void Start()
    {
        ...
        UpdateTarget(true);
        OLDEntityList.Add(gameObject, m_evadeRadius);
    }
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            Vector2 moveDir = OLDEntityList.EvadeDirection(gameObject, new Vector2(dir.x, dir.z));
    ...
    void Fire()
    {
        ...
        if (m_projectilePrefab != null)
        {
            ...
            var bullet = obj.GetComponent<OLDBulletBase>();
            if (bullet != null)
            {
    ...
    void UpdateTarget(bool forceRotation)
    {
        ...
        if (OLDWorldHolder.Instance() != null)
            m_target = OLDWorldHolder.Instance().GetElemPos(e.buildingPos.x, e.buildingPos.y);
