...
public class OLDGameUI : MonoBehaviour
{
    enum ButtonType
    {
        ground,
    ...
    [SerializeField] OLDCursorDefault m_defaultCursor;
    [SerializeField] OLDCursorGround m_groundCursor;
    [SerializeField] OLDCursorTower m_towerCursor;
    [SerializeField] OLDCursorDelete m_deleteCursor;
    ...
    void UpdatePrices()
    {
        ...
        int priceGround = OLDElementHolder.Instance().GetGroundCost(OLDGroundType.normal);
        int priceTower0 = OLDElementHolder.Instance().GetBuildingCost(OldBuildingType.tower0, 0);
        int priceTower1 = OLDElementHolder.Instance().GetBuildingCost(OldBuildingType.tower1, 0);
        int priceTower2 = OLDElementHolder.Instance().GetBuildingCost(OldBuildingType.tower2, 0);
